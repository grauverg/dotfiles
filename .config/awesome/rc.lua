...
globalkeys = gears.table.join(
	...
	awful.key({ mk_alt }, "Tab", awful.tag.viewnext, { description = "view next", group = "tag" }),
	...
	awful.key({ modkey }, "c", function()
		awful.util.spawn("yandex-browser-stable")
	end, { description = "Open browser (Yandex Browser)", group = "My own tweaks" }),
